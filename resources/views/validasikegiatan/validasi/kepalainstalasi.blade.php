...
<div class="modal fade" id="modal-lg{{$d->IdCatKegiatan}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
        ...
        <form class="forms-sample" action="{{ route('updateverif', $d->IdCatKegiatan) }}" method="POST">
            @csrf
            @method('put')
            <div class="table-responsive">
                            ...
                            <div class="form-group">
                                <h5>Catatan</h5>
                                <textarea class="form-control" name="cat_atasan_1" rows="10" cols="100%" placeholder="Komentar..">{{ $d->catatan }}</textarea>
                            </div>
                         </div>
                    </div>
                    <input type="text" name="catatan" value="{{ $d->IdCatKegiatan }}" hidden>
